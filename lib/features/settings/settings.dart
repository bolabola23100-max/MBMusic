            ...
            builder: (context, remaining, _) {
              return _buildSettingTile(
                ...
                subtitle: remaining == null
                    ? 'settings.off'.tr()
                    : '${'settings.stopping_in'.tr()} ${_formatDuration(remaining)}',
          ...
          child: Column(
            ...
            children: [
              ...
              GridView.count(
                ...
                mainAxisSpacing: 16,
                crossAxisSpacing: 16,
                childAspectRatio: 1.6, // Increased for Arabic text
                children: [
                  _timerOption(context, 'settings.off'.tr(), null),
                  _timerOption(context, '15m', const Duration(minutes: 15)),
                  _timerOption(context, '30m', const Duration(minutes: 30)),
                  _timerOption(context, '45m', const Duration(minutes: 45)),
                  _timerOption(context, '1h', const Duration(hours: 1)),
                  _timerOption(context, '2h', const Duration(hours: 2)),
                ],
              ),
              const SizedBox(height: 32),
            ],
